            ...
            <div className="flex flex-col w-full max-w-screen-xl">
                {loading ? (
                    ...
                    <>
                        ...
                        <div className="flex flex-col w-full px-4 py-2 bg-[#e3945e] md:rounded-md md:my-4">
                            <h2 className="text-2xl font-semibold text-heading mb-4 text-white mt-4">Currently Airing</h2>
                            {
                                movies.length > 0 ? (
