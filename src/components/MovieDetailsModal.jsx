    ...
    return (
            <>
                <div className="fixed inset-0 flex justify-center items-center bg-gray-900/60 z-100" onClick={(e) => { if (e.target === e.currentTarget) onClose(); }}>
                    <div className="w-md h-[300px] p-5 bg-gray-100 shadow-xl rounded-md overflow-y-auto">
                        <div className="flex justify-between items-center mb-4">
                            <h2 className="text-lg">{name}</h2> 
                            <button onClick={() => onClose()} className="w-10 h-10 p-1 bg-gray-200 shadow-md rounded-full flex justify-center items-center cursor-pointer"><X /></button>
                        </div>
